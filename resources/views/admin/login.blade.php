...
<head>
    ...
    <title>Admin Login - Srikandi Tour And Travel</title>
        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Srikandi Tour And Travel Admin Panel
                </p>
            </div>
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        ...
                        <input id="username" name="username" type="text" required 
                               ...
                               placeholder="Username atau Email" value="{{ old('username', 'srikanditravel@gmail.com') }}">
                    </div>
                    <div>
