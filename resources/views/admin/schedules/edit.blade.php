...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-900 mb-2">Edit Jadwal</h1>
            <p class="text-lg text-gray-600">Edit informasi jadwal "{{ $schedule->destination }}"</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="destination" id="destination" value="{{ old('destination', $schedule->destination) }}" required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                        ...
                        <div>
                            ...
                            <select name="mode" id="mode" required
                                ...
                                <option value="travel" {{ old('mode', $schedule->mode) == 'travel' ? 'selected' : '' }}>Travel</option>
                                <option value="umroh" {{ old('mode', $schedule->mode) == 'umroh' ? 'selected' : '' }}>Umroh</option>
                            </select>
                        </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea name="description" id="description" rows="8"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                      placeholder="Jelaskan detail jadwal, informasi penting, dan catatan khusus...">{{ old('description', $schedule->description) }}</textarea>
                        </div>
                    </div>
                </div>
