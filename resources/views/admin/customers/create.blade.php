...
<head>
    ...
    <title>Tambah Pelanggan - {{ $package->name }}</title>
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="mb-8 animate-fade-in">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-4xl font-bold bg-gradient-to-r from-gray-100 via-blue-300 to-purple-300 bg-clip-text text-transparent mb-2">Tambah Pelanggan</h1>
                        <p class="text-xl text-gray-300">Paket: {{ $package->name }} - {{ $package->destination }}</p>
                    </div>
            ...
            <div class="bg-gray-800 rounded-3xl shadow-2xl p-8 mb-8 border border-gray-700 animate-slide-up">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-gradient-to-r from-gray-700 to-gray-800 rounded-2xl p-6 border border-gray-600">
                        ...
                        <p class="text-xl font-bold text-gray-100">{{ $package->name }}</p>
                    </div>
                    <div class="bg-gradient-to-r from-gray-700 to-gray-800 rounded-2xl p-6 border border-gray-600">
                        <p class="text-sm text-gray-400 mb-2">Destinasi</p>
                        <p class="text-xl font-bold text-gray-100">{{ $package->destination }}</p>
                    </div>
                    <div class="bg-gradient-to-r from-gray-700 to-gray-800 rounded-2xl p-6 border border-gray-600">
                        <p class="text-sm text-gray-400 mb-2">Harga Paket</p>
                        <p class="text-xl font-bold text-blue-400">Rp {{ number_format($package->price, 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-800 rounded-3xl shadow-2xl p-8 border border-gray-700 animate-slide-up">
                <form action="{{ route('admin.customers.store', $package) }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="visa_number" name="visa_number" value="{{ old('visa_number') }}"
                                       class="w-full px-4 py-3 border border-gray-600 rounded-xl shadow-sm placeholder-gray-500 bg-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="address" name="address" rows="3"
                                          class="w-full px-4 py-3 border border-gray-600 rounded-xl shadow-sm placeholder-gray-500 bg-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">{{ old('address') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="total_payment" name="total_payment" value="{{ old('total_payment', $package->price) }}" required min="0" step="1000"
                                       class="w-full px-4 py-3 border border-gray-600 rounded-xl shadow-sm placeholder-gray-500 bg-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">
                            </div>
                            
                            <div>
                                <label for="paid_amount" class="block text-sm font-semibold text-gray-300 mb-3">Sudah Dibayar *</label>
                                <input type="number" id="paid_amount" name="paid_amount" value="{{ old('paid_amount', 0) }}" required min="0" step="1000"
                                       class="w-full px-4 py-3 border border-gray-600 rounded-xl shadow-sm placeholder-gray-500 bg-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="notes" name="notes" rows="4"
                                          class="w-full px-4 py-3 border border-gray-600 rounded-xl shadow-sm placeholder-gray-500 bg-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300">{{ old('notes') }}</textarea>
                            </div>
                        </div>
                    </div>
