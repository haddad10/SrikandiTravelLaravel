...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-900 mb-2">Tambah Foto Baru</h1>
            <p class="text-lg text-gray-600">Upload foto destinasi untuk galeri travel dan umroh</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            <form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label for="image" class="block text-sm font-semibold text-gray-700 mb-2">Upload Foto *</label>
